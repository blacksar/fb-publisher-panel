...
import { Calendar, FileText, ImageIcon, MessageSquare, Settings, Users, ChevronLeft, ChevronRight } from "lucide-react"
...
const menuItems: { path: string; label: string; icon: typeof Calendar; adminOnly?: boolean }[] = [
