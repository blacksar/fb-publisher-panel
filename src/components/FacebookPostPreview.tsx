...
export function FacebookPostPreview({
  ...
  return (
    ...
    >
      ...
      {/* Comentario de la página: avatar + burbuja gris (saltos de línea preservados) */}
      {comment?.trim() ? (
        <div className="flex items-start gap-2 px-3 pb-3 pt-1">
          ...
          <div className="min-w-0 rounded-2xl rounded-tl-sm bg-muted/80 px-3 py-2">
            <p className="break-words text-[13px] leading-snug text-foreground" style={{ whiteSpace: "pre-wrap" }}>
